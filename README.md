About emoji-extractor-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/emoji-extractor-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/emoji-extractor-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add emoji-extractor
# for installing globally
pixi global install emoji-extractor
```
...
It is possible to list all of the versions of `emoji-extractor` available on your platform:
...
```
pixi search emoji-extractor --channel conda-forge
```
...
* [@alexanderrobertson](https://github.com/alexanderrobertson/)
